...
void LoadErrorPage(CefRefPtr<CefFrame> frame,
  ...
  //      "<br/>Error: " <<  //TODO : luyang /*test_runner::GetErrorString(error_code)*/// <<
  //      " (" << error_code << ")";
...
ClientHandler::ClientHandler(Delegate* delegate,
  ...
  : is_osr_(is_osr),
    ...
    browser_count_(0),
	// TODO : luyang
	console_log_file_("cef_console.log"), 
...
void client::ClientHandler::AddMessageHandler(CefMessageRouterBrowserSide::Handler * handler)
{
